...
const handleAIComplete = async (data: any, bioSummary: string) => {
    try {
        ...
        if (isOwnProfile) await refreshProfile();
        else setProfileUser({ ...profileUser, ai_profile: data, bio: bioSummary });
        success("AI Profile Updated!");
    } catch (e) {
        console.error(e);
                                                    ...
                                                    <div>
                                                        ...
                                                        {isOwnProfile && (
                                                            <button
                                                                ...
                                                                className="text-xs font-bold text-violet-600 bg-violet-50 hover:bg-violet-100 px-3 py-1.5 rounded-lg border border-violet-100 transition-colors flex items-center gap-1.5 ml-auto md:ml-0"
                                                            >
                                                                <Sparkles size={14} />
