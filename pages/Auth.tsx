...
import { Mail, Lock, ArrowRight, GraduationCap, PenTool, Search, Phone, MessageCircle } from 'lucide-react';
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <div
                                    ...
                                    className={`cursor-pointer rounded-xl border p-4 flex flex-col items-center justify-center text-center transition-all duration-200 ${
                                        !completionIsWriter 
                ...
                <div className="max-w-md w-full mx-auto">
                    <div className="mb-10 text-center lg:text-left">
                        ...
                        <p className="text-slate-500 dark:text-slate-400 font-medium text-lg">
                            {isReg ? 'Join the community of ambitious students.' : 'Please enter your details to sign in.'}
                        </p>
                    </div>
                    ...
                    <div className="space-y-4 mb-8">
                        <button
                            ...
                            disabled={loading}
                            className="w-full flex items-center justify-center gap-3 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-white font-bold py-3 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-700 transition-all shadow-sm disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <GlassButton type="submit" isLoading={loading} className="w-full mt-4 shadow-orange-500/20">
                    ...
                    <div className="mt-6 text-center">
                        <a 
                            ...
                            target="_blank" 
                            rel="noreferrer" 
                            className="inline-flex items-center gap-2 text-xs font-bold text-green-600 hover:text-green-700 bg-green-50 px-4 py-2 rounded-full border border-green-200 transition-colors"
                        >
