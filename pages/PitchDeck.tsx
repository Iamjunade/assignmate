                ...
                <AnimatePresence mode="wait">
                    ...
                    >
                        ...
                        <motion.div
                            ...
                            className={`rounded-[2rem] bg-white/5 backdrop-blur-xl border border-white/10 mb-8 overflow-hidden ${slide.color} ${slide.type === 'hero' ? 'p-0' : 'p-6'}`}
                        >
                            {slide.type === 'hero' ? (
                                <img src="/logo.png" alt="AssignMate Logo" className="w-48 h-48 object-cover drop-shadow-2xl" />
                            ) : (
