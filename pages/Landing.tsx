        ...
        <div className="relative z-10 space-y-32 pb-32 overflow-hidden">
            ...
            <div className="relative">
                <Hero
                    ...
                    description="Connect with top-tier students from IITs & NITs. Outsource assignments, projects, and records with guaranteed quality."
                    badgeText="India's #1 Student Marketplace"
                    badgeLabel="New"
                    ctaButtons={[
                        { text: "Start Hiring Now", href: "/auth", primary: true },
                        { text: "Become a Writer", href: "/auth" }
                    ]}
