    ...
    return (
        <aside className="w-72 h-full hidden lg:flex flex-col border-r border-border-subtle bg-white z-20 shrink-0 shadow-[4px_0_24px_-12px_rgba(0,0,0,0.02)]">
            <div className="h-20 flex items-center px-8 border-b border-border-subtle">
                <div className="flex items-center gap-3 text-text-dark cursor-pointer" onClick={() => navigate('/feed')}>
                ...
                {isWriterMode ? (
                    ...
                    <>
                        <a
                            ...
                            className={`flex items-center gap-3 px-4 py-3.5 rounded-2xl transition-all group cursor-pointer ${isActive('/connections') ? 'bg-primary/10 text-primary ring-1 ring-primary/20' : 'hover:bg-secondary-bg text-text-muted'}`}
                        >
                            ...
                            {incomingRequestsCount > 0 && (
                                <span className="ml-auto bg-primary text-white text-[10px] font-bold px-2 py-0.5 rounded-full shadow-sm">{incomingRequestsCount}</span>
                            )}
                        </a>
                        <a
                        ...
                        <a
                            ...
                            className={`flex items-center gap-3 px-4 py-3.5 rounded-2xl transition-all group cursor-pointer ${isActive('/earnings') ? 'bg-primary/10 text-primary ring-1 ring-primary/20' : 'hover:bg-secondary-bg text-text-muted'}`}
                        >
