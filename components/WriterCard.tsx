...
const WriterCard: React.FC<WriterCardProps> = ({ writer, onChat, index, onToggleSave, isSaved, connectionStatus = 'none', onConnect }) => {
  ...
  return (
    <motion.div 
        ...
        whileHover={{ y: -4 }}
        className="bg-white border border-slate-200 rounded-2xl overflow-hidden hover:shadow-xl hover:shadow-orange-100 hover:border-orange-200 transition-all group"
    >
      <div className="p-5">
